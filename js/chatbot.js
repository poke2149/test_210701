...
function select_exp(num) {
    switch (num) {
        case 0:
            ...
            chat_choice_exp0.style.marginLeft = "31%";
        ...
        case 1:
            ...
            chat_choice_exp0.style.marginLeft = "27%";
        ...
        case 4:
            ...
            } // 사서 url 부분 이미지 위치 보정 조건문
            else if(localStorage.getItem("item") == 6){
                url_txt_list[2].style.marginTop = "48%";
                url_txt_list[3].style.marginTop = "58%";
            } // 드론 url 부분 이미지 위치 보정 조건문
            else if(localStorage.getItem("item") == 7){
                url_txt_list[2].style.marginTop = "48%";
                url_txt_list[3].style.marginTop = "58%";
            } // 드론 url 부분 이미지 위치 보정 조건문
            else if(localStorage.getItem("item") == 10){
                url_txt_list[2].style.marginTop = "48%";
            } // 드론 url 부분 이미지 위치 보정 조건문
            break;
    }
...
function helth_care() {
    if(localStorage.getItem("item") == 11){
        exp_list[2].style.marginTop = "80%";
        exp_list[3].style.marginTop = "90%";
        exp_list[4].style.marginTop = "100%";
    }
}// 헬스케어 질문 리스트 위치 보정
function exp_onoff() {
